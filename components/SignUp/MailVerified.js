    ...
    return (
        ...
        <div className='md:w-96 w-full mx-auto h-full justify-center items-center text-center flex flex-col my-10 p-4'>
            ...
            <svg width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M33.0007 28.3335V33.0002M33.0007 37.6668H33.0123M44.6673 33.0002C44.6673 39.4435 39.444 44.6668 33.0007 44.6668C26.5573 44.6668 21.334 39.4435 21.334 33.0002C21.334 26.5568 26.5573 21.3335 33.0007 21.3335C39.444 21.3335 44.6673 26.5568 44.6673 33.0002Z" stroke="#039855" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round" />
