    ...
    return (
        ...
        <div className='sm:w-96 w-full mx-auto h-full justify-center items-center text-center flex flex-col my-10 p-4'>
            ...
            <svg width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M33.0007 28.333V32.9997M33.0007 37.6663H33.0123M44.6673 32.9997C44.6673 39.443 39.444 44.6663 33.0007 44.6663C26.5573 44.6663 21.334 39.443 21.334 32.9997C21.334 26.5564 26.5573 21.333 33.0007 21.333C39.444 21.333 44.6673 26.5564 44.6673 32.9997Z" stroke="#504F4F" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <div className="form flex gap-2 mt-3">
                ...
                <input
                    ...
                    placeholder="0"
                    required
                    className="appearance-none block text-5xl text-center mb-4 w-full bg-white text-gray-400 border border-gray-200 rounded-lg p-2 focus:outline-none focus:bg-white"
                />
                <input
                    id=""
                    type="text"
            ...
            <a href="#" className="flex items-center gap-2 my-2 text-gray-500 text-sm"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.99935 18.3337C14.6017 18.3337 18.3327 14.6027 18.3327 10.0003C18.3327 5.39795 14.6017 1.66699 9.99935 1.66699C5.39698 1.66699 1.66602 5.39795 1.66602 10.0003C1.66602 14.6027 5.39698 18.3337 9.99935 18.3337Z" stroke="#667085" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
                Back to log in</a>
        </div>
