...
export default function BlogMainIndex({categoriesList, slug = ''}) {
    ...
    return (
        <div className="lg:pb-10 pb-5 md:mt-20 mt-16">
            ...
            <div className="max-w-7xl mx-auto flex md:flex-row flex-col px-4 relative">
                ...
                <div className='md:w-3/4 w-full'>
                    <div className='flex  flex-wrap'>
                        ...
                        {data && posts && posts.map((blog, index) => {
                            if (index === 0) {
            ...
            { data && data.meta && data.meta.pagination && data.meta.pagination.pageCount > 1 && <div className="max-w-7xl mx-auto flex items-center justify-center py-10 px-4"><Paginate data={data.meta.pagination} pageIndex={pageIndex} setPageIndex={setPageIndex} /></div>}
        </div>
    )
}