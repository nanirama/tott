        ...
        <>
            <div className="lg:py-10 py-5">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className='flex lg:flex-row flex-col md:gap-8 gap-2'>
                        <div className='lg:w-1/3 w-full mb-8'>
                            ...
                            <div className='flex gap-2'>
                                <a href="#" class="bg-slate-100 text-gray-700 font-medium rounded-2xl text-sm py-1 px-2 inline-block">Design</a>
                                <a href="#" class="bg-slate-100 text-blue-600 font-medium rounded-2xl text-sm py-1 px-2 inline-block">Research</a>
                                <a href="#" class="bg-pink-100 text-pink-700 font-medium rounded-2xl text-sm py-1 px-2 inline-block">Presentation</a>
                            </div>
                        </div>
                        <div className='lg:w-1/3 w-full mb-8'>
                        ...
                        <div className='lg:w-1/3 w-full mb-8'>
                            ...
                            <p className='text-gray-500 font-normal text-base mb-5'>How do you create compelling presentations that wow your colleagues and impress your managers?</p>
                            <div className='flex gap-2'>
                                <a href="#" class="bg-green-100 text-green-700 font-medium rounded-2xl text-sm py-1 px-2 inline-block">Software Development</a>
                                <a href="#" class="bg-pink-100 text-pink-600 font-medium rounded-2xl text-sm py-1 px-2 inline-block">Tools</a>
                    ...
                    <a href="#" class="inline-flex justify-center items-center rounded-lg bg-zinc-600 border border-zinc-600 py-3 px-5 text-white text-base font-medium  text-center">View All Posts</a>
                    </div>
                    <hr className="my-8" />
                </div>
