        ...
        <div className="w-full">
            <div className="max-w-7xl mx-auto flex flex-col px-4 lg:py-20 py-10">
                <div class="xl:w-3/5 w-full lg:mb-12 mb-8">
                    <h6 class="text-base font-semibold mb-3">Upgrade</h6>
                    <h2 class="lg:text-4xl text-2xl font-semibold tracking-tight mb-4">Unlock more features</h2>
                ...
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-10">
                    ...
                    <div className='border rounded-lg shadow-lg'>
                        ...
                        <div className='flex gap-3 sm:flex-row justify-between flex-col-reverse mb-3 p-8 border-b'>
                            ...
                            <div>
                                <p><span class="md:text-5xl text-4xl font-extrabold text-gray-900">$10</span> <span class="text-base font-normal text-gray-500">per month</span></p>
                            </div>
                        </div>
                        ...
                        <div className='p-8 flex'>
                            <a href="#" class="text-center rounded-lg bg-zinc-600 border border-zinc-600 py-3 px-5 text-white text-base font-medium w-full">Get Started</a>
