    ...
    return (
        ...
        <div className="w-full">
            <div className="max-w-4xl mx-auto flex flex-col px-4 lg:py-20 pb-5 pt-10 text-center">
                <h6 class="text-base font-semibold mb-4">Features</h6>
                <h2 class="md:text-4xl text-3xl font-semibold mb-5">Beautiful analytics to grow smarter</h2>
                <p class="text-xl text-gray-500">Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups.</p>
            </div>
                    ...
                    <div className='lg:w-1/2 w-full'>
                        ...
                        <div className='lg:mt-10 xl:mb-0 mb-3'>
                            ...
                            <div class="flex md:flex-row flex-col justify-start">
                                <a href="#" class="flex items-center gap-2 inline-block text-center rounded-lg bg-white border border-slate-300 py-3 px-5 text-gray-600 text-base font-medium md:mr-3 md:mb-0 mb-3 md:w-auto w-full"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.0001 18.3332C14.6025 18.3332 18.3334 14.6022 18.3334 9.99984C18.3334 5.39746 14.6025 1.6665 10.0001 1.6665C5.39771 1.6665 1.66675 5.39746 1.66675 9.99984C1.66675 14.6022 5.39771 18.3332 10.0001 18.3332Z" stroke="#344054" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M8.33342 6.6665L13.3334 9.99984L8.33342 13.3332V6.6665Z" stroke="#344054" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round" />
                                </svg> Demo</a>
                                <a href="#" class="inline-block text-center rounded-lg bg-zinc-600 border border-zinc-600 py-3 px-5 text-white text-base font-medium md:w-auto w-full">Learn more</a>
                            </div>
