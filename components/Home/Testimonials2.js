            ...
            <div className="lg-w-7xl mx-auto px-4">
                <div className="max-w-7xl mx-auto px-2 flex lg:flex-row flex-col justify-between mb-16">
                    ...
                    <div class="flex md:flex-row flex-col items-start">
                        <a href="#" class="inline-block text-center rounded-lg py-3 border md:mr-4 md:mb-0 mb-3 px-5 text-gray-700 text-base font-medium md:w-auto w-full">Our customers</a>
                        <a href="#" class="inline-block text-center rounded-lg bg-zinc-600 py-3 px-5 text-white text-base font-medium md:w-auto w-full">Create account</a>
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-8">
                    <div className="relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 border-t py-5 px-4 bg-white/[0.3]">
                            ...
                            <h3 class="md:text-3xl text-xl font-semibold text-white mb-4"><a href="#">Alisa Hester</a></h3>
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 border-t py-5 px-4 bg-white/[0.3]">
                            ...
                            <h3 class="xl:text-3xl md:text-2xl text-xl font-semibold text-white mb-4"><a href="#">Annie Stanley</a></h3>
