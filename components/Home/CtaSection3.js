    ...
    return (
        ...
        <div className="w-full bg-gray-100">
            <div className="max-w-7xl mx-auto flex flex-col px-4 lg:py-20 py-10">
                <div class="lg:grid lg:grid-cols-2 grid-cols-1 flex lg:flex-row flex-col-reverse">
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute bottom-6 left-5 right-5 border text-left py-5 px-4 bg-white/[0.4]">
                                    ...
                                    <div class="flex justify-between items-center md:mb-4 mb-3">
                                        <h3 class="xl:text-4xl text-2xl font-semibold text-white mb-0">Noah Pierre</h3>
                    ...
                    <div className="bg-white md:p-10 py-10 px-4 flex flex-col justify-center">
                        ...
                        <div class="flex md:flex-row flex-col justify-start">
                            <a href="#" target="_blank" class="inline-block text-center rounded-lg bg-white border border-slate-300 py-3 px-5 text-gray-600 text-base font-medium md:mr-3 md:mb-0 mb-3 md:w-auto w-full">Learn More</a>
                            <a href="#" target="_blank" class="inline-block text-center rounded-lg bg-zinc-600 border border-zinc-600 py-3 px-5 text-white text-base font-medium md:w-auto w-full">Get Started</a></div>
                    </div>
                </div>
            </div>
        </div>
