                    ...
                    <ImgLoader src={Author1} width={384} height={480} alt="Team member" />  
                        ...
                        <div className='absolute bottom-6 left-5 right-5 border py-5 px-4 bg-white/[0.3]'>
                            <div class="flex justify-between items-center mb-3">
                                ...
                                <a href="#"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 11L11 1M11 1H1M11 1V11" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></a>
                            </div>
