...
export default function Features5() {
    ...
    return (
        <div className="w-full lg:py-10 py-5">
            <div class="lg:max-w-5xl mx-auto w-full mf:mb-14 mb-10 text-center px-4">
                <h6 class="text-base font-semibold mb-3">Features</h6>
                <h2 class="lg:text-4xl text-2xl font-semibold tracking-tight mb-4">Cutting-edge features for advanced analytics</h2>
            ...
            <div className="max-w-7xl mx-auto flex flex-col px-4">
                <div class="grid md:grid-cols-3 grid-cols-1 lg:gap-14 gap-4">
                    <div>
