            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center flex items-center flex-col">
                    <svg width="56" height="56" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M34.1667 21.333L22.5 35.333H33L31.8333 44.6663L43.5 30.6663H33L34.1667 21.333Z" stroke="white" stroke-width="2.33333" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <dl className="sm:grid sm:grid-cols-4 md:mt-10 mt-3">
                    <div className="flex flex-col border-b border-gray-500 lg:px-6 px-4 md:py-2 py-4 sm:border-0 sm:border-r-2 sm:border-l-2">
                        <dt className="order-3 mt-2 text-lg leading-6 font-medium text-gray-500">
                            <a href="#" class="flex items-center text-gray-600 visited:text-zinc-700 font-medium">Learn More
                                <svg width="28" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.16675 7.00033H12.8334M12.8334 7.00033L7.00008 1.16699M12.8334 7.00033L7.00008 12.8337" stroke="#323232" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            </a>
                        </dt>
