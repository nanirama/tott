...
import FeatureImg3 from "../../assets/images/features-img3.png";
...
export default function Features5() {
    ...
    return (
        <div className="w-full lg:py-10 py-5">
            <div className="lg:max-w-5xl mx-auto w-full mf:mb-14 mb-10 text-center px-4">
                <h6 className="text-base font-semibold mb-3">Features</h6>
                <h2 className="lg:text-4xl text-2xl font-semibold tracking-tight mb-4">Cutting-edge features for advanced analytics</h2>
              
                    <p className='lg:text-xl text-base text-gray-500 lg:leading-8'>Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups.</p>
               
            </div>
            <div className="max-w-7xl mx-auto flex flex-col px-4">
                <div className="grid md:grid-cols-3 grid-cols-1 lg:gap-14 gap-4">
                    <div>
                    ...
                    <div className=''>
                        <ImgLoader src={FeatureImg3} width={552} height={516} alt="feature image" />
                    </div>
