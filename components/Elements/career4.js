        ...
        <div className="lg:py-14 py-10 ">
            <div className="max-w-7xl mx-auto flex flex-col px-4">
                ...
                <div className="lg:w-3/5 w-full mb-10">
                    <h6 className="text-gray-700 text-base font-semibold mb-2">We&lsquo;re hiring!</h6>
                    <h2 className="md:text-4xl text-3xl text-gray-900 font-semibold tracking-tight md:mb-6 mb-4">We’re looking for talented people</h2>
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-16 gap-5">
                    ...
                    <div>
                        ...
                        <div className="border-t border-zinc-200 py-6">
                            ...
                            <p className="font-normal text-gray-500 text-base mb-5">We&lsquo;re looking for a mid-level UX designer to join our team.</p>
