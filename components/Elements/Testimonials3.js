                        ...
                        <div className="md:w-1/2 w-full flex flex-col items-start px-4">
                            <div>
                                <div className='flex flex-row mb-4'>
                                    ...
                                    <p className="xl:text-5xl lg:text-4xl text-3xl md:leading-tight md:tracking-tight text-gray-900 font-medium  md:mb-12 mb-6">Untitled has saved us thousands of hours of work. We’re able to spin up projects and features faster.</p>
                                <div className="flex justify-between md:items-center md:flex-row flex-col w-full md:mb-0 mb-12">
                                    <div>
                                        <h6 className="text-gray-900 text-lg font-medium">Alisa Hester</h6>
                    ...
                    <div className="flex md:flex-row flex-col">
                        <div className="md:w-1/2 w-full flex flex-col items-start px-4">
                            <div>
                                ...
                                <div className="flex justify-between md:items-center md:flex-row flex-col w-full md:mb-0 mb-12">
                                    <div>
                                        <h6 className="text-gray-900 text-lg font-medium">Johnny Bell</h6>
                                        <p className="text-gray-500 text-base">Hourglass</p>
                                    </div>
                                </div>
                            </div>
