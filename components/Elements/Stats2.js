    ...
    return (
        ...
        <div className="lg:py-20 py-10 w-full border-b border-slate-200">
            <div className="max-w-4xl mx-auto flex flex-col px-4 text-center items-center lg:mb-14 mb-5">
                ...
                <h2 className="md:text-4xl text-3xl font-semibold tracking-tight md:mb-6 mb-4">We're only just getting started on our journey</h2>
                    ...
                    <div className='md:p-14 p-5 bg-zinc-600/50 flex md:flex-row flex-col gap-8'>
                        <div className='md:w-1/3 sm:w-1/2 w-full'>
                            <div className='border py-5 px-5 bg-white/[0.3] text-center'>
                                ...
                                <p className='text-base font-semibold text-white mb-2'>Projects completed</p>
                                <p className='text-sm text-white mb-2'>We've helped build over 400 projects with great companies.</p>
                            </div>
                        </div>
                        <div className='md:w-1/3 sm:w-1/2 w-full'>
                            <div className='border py-5 px-5 bg-white/[0.3] text-center'>
                                <h3 className="lg:text-6xl text-3xl font-semibold text-white mb-4 mt-3">600%</h3>
                                <p className='text-base font-semibold text-white mb-2'>Return on investment</p>
                                <p className='text-sm text-white mb-2'>We've helped build over 400 projects with great companies.</p>
                            </div>
                        </div>
                        <div className='md:w-1/3 sm:w-1/2 w-full'>
                            <div className='border py-5 px-5 bg-white/[0.3] text-center'>
                                <h3 className="lg:text-6xl text-3xl font-semibold text-white mb-4 mt-3">10K</h3>
                                <p className='text-base font-semibold text-white mb-2'>Global downloads</p>
                                <p className='text-sm text-white mb-2'>We've helped build over 400 projects with great companies.</p>
                            </div>
                        </div>
                    </div>
