            ...
            <div className="bg-zinc-900 lg:py-20 py-8">
                <div className="max-w-7xl mx-auto flex md:flex-row flex-col px-4">
                    ...
                    <div className='md:w-1/3 w-full'>
                        ...
                        <p className="text-base font-light text-gray-300 mb-8 text-white w-40">100 Flinders Street<br /> Melbourne VIC 3000 AU</p>

                        <h6 className="text-xl text-white mb-3 w-full">Sydney</h6>
                        <p className="text-base font-light text-gray-300 mb-8 text-white w-40">100 George Street<br /> Sydney NSW 2000</p>

                        <h6 className="text-xl text-white mb-3 w-full">Byron Bay</h6>
                    ...
                    <div className='md:w-1/3 w-full'>
                        ...
                        <p className="text-base font-light text-gray-300 mb-8 text-white w-40">100 Oxford Street<br /> London W1D 1LL UK</p>

                        <h6 className="text-xl text-white mb-3 w-full">San Francisco</h6>
                        <p className="text-base font-light text-gray-300 mb-8 text-white w-40">100 Market  Street<br /> San Francisco, CA 94105 USA</p>

                        <h6 className="text-xl text-white mb-3 w-full">Sweden</h6>
                        <p className="text-base font-light text-gray-300 mb-8 lg:mb-0 text-white w-40">Drottninggatan 100<br /> 111 60 Stockholm SE</p>
                    </div>
