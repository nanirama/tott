      ...
      <div className="bg-white md:pt-24 pt-14">
        <div className="max-w-7xl mx-auto text-center px-4">
          ...
          <div className="mt-8 flex md:flex-row flex-col justify-center md:mb-16 mb-10">
              <a href="#" className="inline-block bg-white items-center justify-center md:mr-3 md:mb-0 mb-3 px-5 py-3 border border-slate-300 text-base font-medium rounded-lg text-gray-700">
                Learn More
              </a>
            <Button/>
            </div>
