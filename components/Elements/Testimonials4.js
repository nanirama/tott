...
export default function Testimonials4({ testimonials }) {
  const settings = {
    dots: true,
    arrow: false,
    speed: 500,
  ...
  return (
    <div className="lg:py-20 py-10 w-full text-center md:mb-0 mb-12">
      <div className="max-w-6xl mx-auto px-4 flex items-center flex-col justify-center">
        <Slider {...settings} className="testimonial4 w-full">
          {testimonials?.map((testimonial, index) => (
            <div className="mb-10" key={index}>
              <h2 className="lg:text-4xl text-2xl  text-gray-900 font-medium mb-10">
          ...
          {/* <div className="mb-10">
            <h2 className="lg:text-4xl text-2xl  text-gray-900 font-medium mb-10">
              ...
              support. We can&lsquo;t imagine working without it.
            </h2>
            <div className=" mb-2 flex justify-center">
