      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center flex items-center flex-col">
          ...
          >
            ...
            />
            <path
              d="M34.1667 21.333L22.5 35.333H33L31.8333 44.6663L43.5 30.6663H33L34.1667 21.333Z"
              stroke="white"
              strokeWidth="2.33333"
              strokeLinecap="round"
        ...
        <dl className="sm:grid sm:grid-cols-4 md:mt-10 mt-3">
          {data?.stats &&
            data?.stats?.map((stat, index) => (
              <div
                className="flex flex-col border-b border-gray-500 lg:px-6 px-4 md:py-2 py-4 sm:border-0 sm:border-r-2 sm:border-l-2"
                key={index}
              >
                {stat.url && (
                  <dt className="order-3 mt-2 text-lg leading-6 font-medium text-gray-500">
                    <Link href={stat.url}>
                      <a className="flex items-center text-gray-600 visited:text-zinc-700 font-medium">
                        Learn More
                        <svg
                          width="28"
                          height="14"
                ...
                <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500 mb-2">
                  {stat.title}
                </dt>
                <dd className="order-1 lg:text-5xl text-3xl font-extrabold text-white tracking-tighter mb-2">
                  {stat.figures}
                </dd>
              </div>
            ))}
