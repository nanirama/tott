...
export default function Career3({ currentJobs }) {
  const {
    heading,
    short_description,
    jobs,
    ...
    <div className="lg:py-14 py-10  bg-black">
      <div className="max-w-7xl mx-auto flex flex-col px-4">
        <div className="lg:w-3/5 w-full mb-10">
          <h6 className="text-gray-500 text-base font-semibold mb-2">
            We&lsquo;re hiring!
          </h6>
          <h2 className="md:text-4xl text-3xl text-white font-semibold tracking-tight md:mb-6 mb-4">
            {heading}
          </h2>
          <p className="text-xl text-gray-500">{short_description}</p>
        </div>
          ...
          <div>
            {jobs?.data?.map(
              ({
                ...
                <div className="border-t border-zinc-700 py-6" key={id}>
                  <h5 className="font-medium lg:text-lg text-white mb-2">
                    {title}
                  </h5>
                  <p className="font-normal text-gray-400 text-base mb-5">
                    {short_description}
                  </p>
