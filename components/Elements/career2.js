    ...
    return (
        <div className="lg:py-14 py-10 px-4">
            <div className="max-w-4xl mx-auto flex flex-col">
                ...
                <div className="border border-slate-200 p-5 rounded-lg mb-5">
                    <p className="text-sm font-semibold mb-2">Software Development</p>
                    <div className='flex gap-3 sm:flex-row flex-col mb-3'>
                ...
                <div className="border border-slate-200 p-5 rounded-lg mb-5">
                    <p className="text-sm font-semibold mb-2">Customer Success</p>
                    <div className='flex gap-3 sm:flex-row flex-col mb-3'>
                ...
                <div className="border border-slate-200 p-5 rounded-lg mb-5">
                    <p className="text-sm font-semibold mb-2">Sales</p>
                    <div className='flex gap-3 sm:flex-row flex-col mb-3'>
