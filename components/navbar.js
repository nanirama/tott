...
function MobileNav({ data, error, open, setOpen }) {
  ...
  const menuItems = data && data.menus && data.menus[0] && data.menus[0].items ? data.menus[0].items : []
...
export default function NavBar() {
  ...
  const header_menu = data && data.menus && data.menus[0] && data.menus[0].items ? data.menus[0].items : []
