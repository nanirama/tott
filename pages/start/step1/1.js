                    ...
                    <div>
                        ...
                        <div className="form">
                            <input
                                ...
                                placeholder="1234 Nortwest 39th Street, Oklahoma..."
                            />
                            <button className="rounded bg-gray-100 border text-base border-solid border-gray-200 text-gray-300 px-6 py-2 text-white mb-3">Submit</button>
                        </div>
                        </div>
