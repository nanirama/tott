...
<div className="md:max-w-screen-sm w-full mx-auto bg-gray-50  h-screen flex flex-col justify-between">
  ...
  <div className="px-5 h-full py-6 flex flex-col justify-between">
                        ...
                        <div>
                            <h2 className="text-black font-medium text-xl">How often do you service your customers?</h2>
                                ...
                                <div className="flex mb-3">
                                    <div className="w-full pl-2 py-3 pr-6  border border-solid border-gray-500 rounded bg-gray-200">
                                        <div className="form-check flex">
                                            ...
                                            <input className="form-check-input h-4 w-4 border-0 border-gray-300 rounded-sm bg-black  checked:bg-transparent checked:border-blue-600 focus:outline-none mt-1 transition duration-200 align-top bg-no-repeat bg-center bg-contain float-right cursor-pointer" type="checkbox" value="" id="CheckeBox-4" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex mb-3">
                                    <div className="w-full pl-2 py-3 pr-6  border border-solid border-gray-500 rounded bg-gray-200">
                                        <div className="form-check flex">
                                            ...
                                            <input className="form-check-input h-4 w-4 border-0 border-gray-300 rounded-sm bg-black  checked:bg-transparent checked:border-blue-600 focus:outline-none mt-1 transition duration-200 align-top bg-no-repeat bg-center bg-contain float-right cursor-pointer" type="checkbox" value="" id="CheckeBox-5" />
                                        </div>
                                    </div>
                                </div>
                                <button className="rounded bg-gray-50 px-6 py-2 text-gray-300 hover:bg-green-400 hover:text-white  mb-3 border-gray-300 border">Submit</button>
                            </div>
                        </div>
