                ...
                <div className="w-full mx-auto h-screen flex flex-col justify-between">
                    <div className="h-full pt-6 flex justify-between flex-col items-center">
                        ...
                        <div className="text-center px-5">
                            <h6 className="text-xs text-white font-medium mb-2">HOLD TIGHT</h6>
                            <h3 className="text-3xl text-white font-bold mb-4">We’re building your new website</h3>
                            <h4 className="text-8xl text-white font-bold leading-normal mb-4">89%</h4>
                        </div>
